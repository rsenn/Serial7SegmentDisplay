...
display(char number, int digit) {
  ...
  if(digit == 4) {
    ...
    switch(number) // Set PORTD, display pins, to correct output
    {
      ...
      case 10:
      case 'a':
      case 'A': PORTD = 0b11101110; break;
      case 11:
      case 'b':
      case 'B': PORTD = 0b11111000; break;
      case 12:
      case 'c':
      case 'C': PORTD = 0b01110010; break;
      case 13:
      case 'd':
      case 'D': PORTD = 0b10111100; break;
      case 14:
      case 'e':
      case 'E': PORTD = 0b11110010; break;
      case 15:
      case 'f':
      case 'F': PORTD = 0b11100010; break;
      case 'h':
      case 'H': PORTD = 0b11101100; break;
      case 'j':
      case 'J': PORTD = 0b00111100; break;
      case 'l':
      case 'L': PORTD = 0b01110000; break;
      case '\xf8': // ascii degree symbol
      case '\xb0': // unicode degree symbol
        PORTD = 0b11001010;
        break;
      case '-': PORTD = 0b10000000; break;
      case '_': PORTD = 0b00010000; break;
      case '`':
      case '~':
      case '^': PORTD = 0b00000010; break;
      case '"': PORTD = 0b01001000; break;
      case '\'': PORTD = 0b01000000; break;
    }
